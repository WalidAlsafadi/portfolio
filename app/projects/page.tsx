...
export default function ProjectsPage() {
  return (
    <>
      <PageIntro eyebrow="Work" title="Selected AI systems and applied research projects" description="A focused archive spanning multi-agent evaluation, Arabic news verification, learning analytics, multimodal retrieval, and data systems." />
