...
export default function ExperiencePage() {
  return (
    <>
      <PageIntro eyebrow="Experience" title="Teaching, research, and data practice" description="Selected roles that connect technical education, research data workflows, and international academic cooperation." />
      <Container className="py-16 md:py-24">
        <div className="border-b border-line">
          {experience.map((item) => (
            <article className="grid gap-5 border-t border-line py-8 md:grid-cols-12 md:gap-10 md:py-10" key={item.role}>
